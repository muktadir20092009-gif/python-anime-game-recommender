...
while True:
    ...
    print("9. Remove Game")
    print("10. Add Favorite Anime")
    print("11. View Favorite Anime")
    print("12. Remove Favorite Anime")
    print("13. Add Favorite Game")
    print("14. View Favorite Game")
    print("15. Remove Favorite Game")
    print("16. Exit")
